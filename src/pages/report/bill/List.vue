    ...
    <div class="list-page-container">
      <div class="search-container">
        <el-form :inline="true" ref="searchForm" :model="serchParams">
          <el-form-item prop="month" label="账单月份">
            <el-date-picker v-model="serchParams.month" type="month" placeholder="请选择账单月份">
            </el-date-picker>
          </el-form-item>
          <el-form-item prop="billType" label="对账类型">
            <el-select v-model="serchParams.billType" placeholder="请选择对账类型">
              <el-option v-for="item in billType" :key="item.value" :label="item.label" :value="item.value">
              </el-option>
            </el-select>
          </el-form-item>
      ...
      <div class="table-container">
        ...
        <el-table v-if="serchParams.billType === 1" :data="data" v-loading="loadingData" height="100%" @selection-change="selectData" style="width: 100%">
          ...
          <el-table-column prop="billNO" label="订单号">
            <!-- <template slot-scope="scope">
              <div class="table-link" @click="viewDetail(scope.row)">{{scope.row.billNO}}</div>
            </template> -->
          </el-table-column>
          <el-table-column prop="billPrice" label="订单金额">
          </el-table-column>
        ...
        <el-table v-else :data="data" v-loading="loadingData" height="100%" @selection-change="selectData" style="width: 100%">
          <el-table-column type="selection" width="50">
          </el-table-column>
          <el-table-column type="index" label="编号" width="50">
          </el-table-column>
          <el-table-column prop="taskNO" label="任务单号">
            <!-- <template slot-scope="scope">
              <div class="table-link" @click="viewDetail(scope.row)">{{scope.row.taskNO}}</div>
            </template> -->
          </el-table-column>
          <el-table-column prop="billNO" label="订单号">
          </el-table-column>
          ...
          <el-table-column prop="deliveryFee" label="配送费用">
          </el-table-column>
          <el-table-column prop="taskStatus" label="任务状态">
          </el-table-column>
          <el-table-column prop="deliveryUser" label="配送员">
          </el-table-column>
          <el-table-column prop="createTime" label="创建时间">
          </el-table-column>
          <el-table-column prop="finishedTime" label="完成时间">
        ...
        <div class="dialog-body">
          ...
          <div class="base-info">
            <div class="flex-row">
              ...
              <el-form-item label="服务大类" prop="billType">
                <el-select :disabled="infoFlag === 'detail'" v-model="infoData.billType" placeholder="请选择服务大类">
                  <el-option v-for="item in billType" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
